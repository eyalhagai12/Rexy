...
public class SpeechRecognition extends Activity implements Runnable {
    private static final String TAG = SpeechRecognition.class.getName();
    ...
    private final static String LOG_TAG = SpeechRecognition.class.getSimpleName();
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            SpeechRecognition.this.runOnUiThread(
                    () -> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Thread thread = new Thread(SpeechRecognition.this);
                thread.start();
    ...
    private String recognize(float[] floatInputBuffer) {
        if (module == null) {
            Log.d(TAG, assetFilePath(getApplicationContext(), "wav2vec2.ptl"));
